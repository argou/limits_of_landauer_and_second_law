# -*- coding: utf-8 -*-
"""
Tilting_bistable_memory_v10    10/02/2026
...
if __name__ == "__main__":
    ...
    if False:# optional
        # save results
        data = [Umv,Qmv,Wmv,Pmv,Wf,Uqs,Wqs,Sqs,Qqs,Pqs,Hqs]
        save_data(data, 'entropy_4A_data_backup.p')
        
    if False:# optional    
        # load results    
        Umv,Qmv,Wmv,Pmv,Wf,Uqs,Wqs,Sqs,Qqs,Pqs,Hqs = load_data('entropy_4A_data_backup.p')                                 
